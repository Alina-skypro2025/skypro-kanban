...
export const GlobalStyles = createGlobalStyle`
  ...
  *, *::before, *::after {
  ...
  /* ===== Hover эффекты ===== */
  ._hover01:hover {
    background-color: ${theme.colors.hover01};
  }

  ._hover02:hover, .header__user:hover {
    color: ${theme.colors.hover01};
  }
  ._hover02:hover::after, .header__user:hover::after {
    border-left-color: ${theme.colors.hover01};
    border-bottom-color: ${theme.colors.hover01};
  }

  ._hover03:hover {
    background-color: ${theme.colors.hover03};
  ...
  ._purple {
    background-color: ${theme.colors.purple.bg};
  ...
  .pop-browse__status .status__p {
    margin-bottom: 14px;
  }

  .pop-browse__status .status__themes {
    display: flex;
    flex-wrap: wrap;
    align-items: flex-start;
    justify-content: flex-start;
  ...
  .pop-browse__status .status__theme {
    border-radius: 24px;
    border: 0.7px solid rgba(148, 166, 190, 0.4);
    color: #94A6BE;
  ...
  .pop-browse__status .status__theme p {
    font-size: 14px;
    line-height: 1;
    letter-spacing: -0.14px;
  }
  ...
  .theme-down__categories {
    margin-bottom: 20px;
  }

  .theme-down__categories .categories__p {
    margin-bottom: 14px;
  }

  .theme-down__categories .categories__theme {
    display: inline-block;
    width: auto;
    height: 30px;
    padding: 8px 20px;
  ...
  .theme-down__categories .categories__theme p {
    font-size: 14px;
    font-weight: 600;
    line-height: 14px;
    white-space: nowrap;
  ...
  #user-set-target:focus-within .header__pop-user-set {
    display: block;
  }
  ...
  .cards__card, .card {
    ...
    height: 130px;
    background-color: ${theme.colors.cardBackground};
    border-radius: ${theme.sizes.cardBorderRadius};
    display: flex;
    flex-direction: column;
    align-items: flex-start;
    justify-content: stretch;
    padding: 15px 13px 19px;
    margin-bottom: ${theme.sizes.cardMarginBottom};
    box-shadow: ${theme.shadows.card};
  }

  .card._orange {
    border-left: 4px solid ${theme.colors.orange.text};
  }
  .card._green {
    border-left: 4px solid ${theme.colors.green.text};
  }
  .card._purple {
    border-left: 4px solid ${theme.colors.purple.text};
  }
  .card._gray {
    border-left: 4px solid ${theme.colors.gray.text};
  }
