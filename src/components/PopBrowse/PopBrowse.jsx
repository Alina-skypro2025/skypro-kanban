...
import {
  ...
  StyledPopBrowseBlock,
  StyledPopBrowseContent,
  StyledPopBrowseTopBlock,
  StyledPopBrowseTtl,
  StyledPopBrowseStatus,
  StyledStatusP,
  StyledStatusThemes,
  StyledStatusTheme,
  StyledPopBrowseWrap,
  StyledPopBrowseForm,
  StyledFormBrowseBlock,
  StyledFormBrowseArea,
  StyledPopBrowseBtnBrowse,
  StyledBtnGroup,
  StyledBtnBrowseEdit,
  StyledBtnBrowseDelete,
  StyledBtnBrowseClose,
  StyledPopBrowseBtnEdit,
  StyledBtnEditEdit,
  StyledBtnEditDelete,
  StyledBtnEditClose,
    ...
    <StyledPopBrowse id="popBrowse">
      <StyledPopBrowseContainer>
        <StyledPopBrowseBlock>
          <StyledPopBrowseContent>
            <StyledPopBrowseTopBlock>
              <StyledPopBrowseTtl>Название задачи</StyledPopBrowseTtl>
              <div className="categories__theme theme-top _orange _active-category">
                <p className="_orange">Web Design</p>
              </div>
            </StyledPopBrowseTopBlock>
            <StyledPopBrowseStatus>
              <StyledStatusP>Статус</StyledStatusP>
              <StyledStatusThemes>
                <StyledStatusTheme _hide>
                  <p>Без статуса</p>
                </StyledStatusTheme>
                <StyledStatusTheme _gray>
            ...
            <StyledPopBrowseWrap>
              <StyledPopBrowseForm id="formBrowseCard" action="#">
                <StyledFormBrowseBlock>
                  <label htmlFor="textArea01" className="subttl">Описание задачи</label>
                  <StyledFormBrowseArea name="text" id="textArea01" readOnly placeholder="Введите описание задачи..." />
                </StyledFormBrowseBlock>
              </StyledPopBrowseForm>
            ...
            <div className="pop-browse__btn-browse ">
              <div className="btn-group">
                <StyledBtnBrowseEdit><a href="#">Редактировать задачу</a></StyledBtnBrowseEdit>
                <StyledBtnBrowseDelete><a href="#">Удалить задачу</a></StyledBtnBrowseDelete>
              </div>
              <StyledBtnBrowseClose><a href="#">Закрыть</a></StyledBtnBrowseClose>
            </div>
            <div className="pop-browse__btn-edit _hide">
              <div className="btn-group">
                <StyledBtnEditEdit><a href="#">Сохранить</a></StyledBtnEditEdit>
                <StyledBtnEditDelete><a href="#">Отменить</a></StyledBtnEditDelete>
                <StyledBtnEditDelete id="btnDelete"><a href="#">Удалить задачу</a></StyledBtnEditDelete>
              </div>
              <StyledBtnEditClose><a href="#">Закрыть</a></StyledBtnEditClose>
            </div>
          </StyledPopBrowseContent>
        </StyledPopBrowseBlock>
      </StyledPopBrowseContainer>
